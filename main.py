...
d_name_model['xnn_lr_0.001'] = XNN(**{
        ...
        'norm_type':'l2',
        'gate_type':'mul',
        'topk_pair': num_feas * (num_feas-1) / 2,
        'topk_triple': num_feas * (num_feas-1) * (num_feas-2) / 6
    })
d_name_model['xnn_lr_0.0001'] = XNN(**{
        'layer_sizes': [field_sizes, 10, 1],
        'layer_acts': ['tanh', 'none'],
        'layer_keeps': [1, 1],
        'opt_algo': 'adam',
...
d_name_model['xnn_lr_0.00001'] = XNN(**{
        'layer_sizes': [field_sizes, 10, 1],
        'layer_acts': ['tanh', 'none'],
        'layer_keeps': [1, 1],
        'opt_algo': 'adam',
...
d_name_model['xnn_lr_0.000001'] = XNN(**{
        'layer_sizes': [field_sizes, 10, 1],
        'layer_acts': ['tanh', 'none'],
        'layer_keeps': [1, 1],
        'opt_algo': 'adam',
...
for name in ['xnn_lr_0.00001', 'xnn_lr_0.000001']:
